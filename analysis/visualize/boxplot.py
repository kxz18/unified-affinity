...
from .post_editor import post_edit, add_significance


def boxplot(data, x, y, hue=None, post_edit_func=None, save_path=None, test_pairs=None, test_method='t-test_ind', **kwargs):
    ax = sns.boxplot(data=data, x=x, y=y, hue=hue, **kwargs)
    if test_pairs is not None:
        add_significance(ax, test_pairs, data, x, y, hue, kwargs.get('order', None), test_method)
...
if __name__ == '__main__':
    ...
    boxplot(data, x='class', y='value', hue='subtype', save_path='boxplot_test.png',
            test_pairs=[(('A', 'major'), ('A', 'minor'))])