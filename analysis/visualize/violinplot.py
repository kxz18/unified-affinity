...
def violinplot(data, x=None, y=None, hue=None, post_edit_func=None, save_path=None, test_pairs=None, test_method='t-test_ind', **kwargs):
    '''
    data: dict<label, cnt>
    '''
    assert x is not None or y is not None
    ax = sns.violinplot(data=data, x=x, y=y, hue=hue, **kwargs)
