...
def pdb_to_list_blocks(pdb: str, selected_chains: Optional[List[str]]=None, return_chain_ids: bool=False, dict_form: bool=False, allow_het: bool=False) -> Union[List[List[Block]], Dict[str, List[Block]]]:
    '''
    ...
    for chain in structure.get_chains():
        ...
        for residue in chain:
            ...
            if hetero_flag == 'W' and not allow_het and not is_aa(residue):
                continue   # residue from glucose (WAT) or water (HOH), small molecules
            ...
            block = Block(abrv, atoms, id=(res_number, insert_code), properties={'chain': _id})
